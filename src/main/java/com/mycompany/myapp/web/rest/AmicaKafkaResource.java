...
@RestController
@RequestMapping("/api/amica-kafka")
public class AmicaKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(AmicaKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public AmicaKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
